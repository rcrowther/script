...
object Path {
  ...
  /** Returns the /bin of the directory above where this code is sited.
    ...
    * /bin folder.
    *
    * The code is fairly reliable, but not guaranteed. Major apps use
    * a shell script laucher, passing found paths into the running
    * process via. the JVM. This would do for a patch.
    *
